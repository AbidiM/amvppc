...
import news from '../components/pages/actualite/news.jpg';
import { AiFillHome,AiFillTags } from "react-icons/ai";
import { FaCalendarAlt } from "react-icons/fa";
import './arab.css';
import babibBbourguiba from "../components/pages/actualite/habibBourguiba.jpg";
import bourguiba from "../components/pages/actualite/habib_bourguiba.jpg";
import Visit from '../components/pages/actualite/109999057_2685645131717326_3284062148193709641_o.jpg';
import bardo from '../components/pages/actualite/1_BARDO_AMVPPC.jpg';
import photo from '../components/pages/actualite/dummy-preview-image.png';
import partership from '../components/pages/actualite/partnership.jpg';
import salonLivre from '../components/pages/actualite/salon-livre-2019.jpg';
import hannibal from '../components/pages/actualite/bce_hannibal_2603.jpg';
import sgBardo from '../components/pages/actualite/sg-onu-bardo.jpg';
import centre from '../components/pages/actualite/centre-medina-tunis.jpg';
import vote from '../components/pages/actualite/vote-arp-loi-amvppc.jpg';
import { Link } from 'react-router-dom';
import ArHeader from './headerFooter/arHeader';
import ArFooter from './headerFooter/arFooter';


class ActualiteAR extends Component {
    state = {  }
    render() { 
        return ( 
        <div class="p1_actualite" title='actualité'>
            ...
            <div class="titre-actu" aria-label="titre" role="titre">
                ...
                <div class="title-actu" aria-hidden="true">مستجدات</div>
             </div>
            <div class="home-logo">
              <a href="/" role="link" aria-label="استقبال"><AiFillHome/></a> <a aria-hidden="true">&nbsp;&gt;&nbsp;مستجدات </a>
            </div>
            <div>
                <ul class='pages-container'>
                    ...
                    <li class="first-page" >
                        <Link to='/actualite'>
                            <a aria-label='الصفحة الأولى'
                            >1</a>
                        </Link>
                    </li>              
                    <li class="second-page" >
                        <Link to="/news">
                            <a aria-label="الصفحة الثانية">2</a>
                        </Link>
                    </li>                
                    <li class="suivant">
                        <Link to="/news">
                            <a  aria-label="الصفحة التالية">التالي</a>
                        </Link>
                    </li>
                </ul>
            </div>
